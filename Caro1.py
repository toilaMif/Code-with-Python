...
while running: 
        ...
        if thang == 'x':
            if kieu_thang_x == 1 :
                pygame.draw.line(screen, MAU_X, (75, 75), (225, 75), 5)
            if kieu_thang_x == 2 :
                pygame.draw.line(screen, MAU_X, (75, 125), (225, 125), 5)
            if kieu_thang_x == 3 :
        ...
        if thang == 'o':
            if kieu_thang_o == 1 :
                pygame.draw.line(screen, MAU_O, (75, 75), (225, 75), 5)
            if kieu_thang_o == 2 :
                pygame.draw.line(screen, MAU_O, (75, 125), (225, 125), 5)
            if kieu_thang_o == 3 :
                pygame.draw.line(screen, MAU_O, (75, 150), (225, 150), 5)
            if kieu_thang_o == 4 :
                pygame.draw.line(screen, MAU_O, (100, 50), (100, 200), 5)
            if kieu_thang_o == 5 :
                pygame.draw.line(screen, MAU_O, (150, 50), (150, 200), 5)
            if kieu_thang_o == 6 :
                pygame.draw.line(screen, MAU_O,  (200, 50), (200, 200), 5)
            if kieu_thang_o == 7 :
                pygame.draw.line(screen, MAU_O, (80,55), (220,195), 5)
            if kieu_thang_o == 8 :
                pygame.draw.line(screen, MAU_O, (220,55), (80,195), 5)
            # Tạo chữ từ font đã thiết lập
